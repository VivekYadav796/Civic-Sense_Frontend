...
import { getRole, getName, getEmail, isLoggedIn } from '@/lib/auth';
        ...
        <div className="fade-up-2">
          <div style={{
            ...
            <h2 style={{ fontSize: 18, fontWeight: 700 }}>
              ...
              <span style={{
                fontSize: 13, color: '#8b9ab5',
                background: '#1e2a3a', borderRadius: 20,
                padding: '2px 10px', marginLeft: 10, fontWeight: 500,
              }}>
                {complaints.length}
              </span>
            </h2>
            {(role === 'CITIZEN' || role === 'ADMIN') && (
              <button onClick={() => router.push('/complaints/new')} style={{
